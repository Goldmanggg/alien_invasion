...
def create_alien(ai_settings, screen, aliens, alien_number, row_number, ship, alien_width):
...
def create_fleet(ai_settings, screen, aliens, ship):
    ...
    for row_number in range(number_rows):
        for alien_number in range(number_aliens_x):
            create_alien(ai_settings, screen, aliens, alien_number, row_number, ship, alien_width)
